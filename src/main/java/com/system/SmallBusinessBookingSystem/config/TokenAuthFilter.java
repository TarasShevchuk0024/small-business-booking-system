package com.system.SmallBusinessBookingSystem.config;
...
public class TokenAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        UserType userUpperBoundaryRole = tokenService.getUserType(jwt);
        ...
        for (UserType userType : UserType.values()) {
            ...
            if (userType.equals(userUpperBoundaryRole)) {
                break;
            }
        }
